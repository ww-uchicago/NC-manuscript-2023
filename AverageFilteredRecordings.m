...
writematrix(wt_avg_dataset,'C:\Users\Hector Acaron\Dropbox\2019 Dendrites Meeting\SAC Recordings\Wt_avgTraces.txt')
...
for i = 1:size(ant_filenames,1)
    ...
    if (stim_data(1,2) == 400.00) && (stim_data(1,3) == 400.00)
        ...
        ant_area_activeBL = [ant_area_activeBL; trapz((time_range/10000), (Data(time_range,1)-avg_baseline))];
        ant_area_minBL = [ant_area_minBL; trapz((time_range/10000), (Data(time_range,1)-min_baseline))];
        
        ant_amp_activeBL = [ant_amp_activeBL; (max(Data(time_range,1))-avg_baseline)];
        ant_amp_minBL = [ant_amp_minBL; (max(Data(time_range,1))-min_baseline)];
...
writematrix(ant_avg_dataset,'C:\Users\Hector Acaron\Dropbox\2019 Dendrites Meeting\SAC Recordings\Ant_avgTraces.txt')
...
for i = 1:size(tea_filenames,1)
    ...
    if (stim_data(1,2) == 400.00) && (stim_data(1,3) == 400.00)
        ...
        tea_area_activeBL = [tea_area_activeBL; trapz((time_range/10000), (Data(time_range,1)-avg_baseline))];
        tea_area_minBL = [tea_area_minBL; trapz((time_range/10000), (Data(time_range,1)-min_baseline))];
        
        tea_amp_activeBL = [tea_amp_activeBL; (max(Data(time_range,1))-avg_baseline)];
        tea_amp_minBL = [tea_amp_minBL; (max(Data(time_range,1))-min_baseline)];
...
writematrix(tea_avg_dataset,'C:\Users\Hector Acaron\Dropbox\2019 Dendrites Meeting\SAC Recordings\TEA_avgTraces.txt')
...
for i = 1:size(drugs_filenames,1)
    ...
    if (stim_data(1,2) == 400.00) && (stim_data(1,3) == 400.00)
        ...
        drugs_area_activeBL = [drugs_area_activeBL; trapz((time_range/10000), (Data(time_range,1)-avg_baseline))];
        drugs_area_minBL = [drugs_area_minBL; trapz((time_range/10000), (Data(time_range,1)-min_baseline))];
        
        drugs_amp_activeBL = [drugs_amp_activeBL; (max(Data(time_range,1))-avg_baseline)];
        drugs_amp_minBL = [drugs_amp_minBL; (max(Data(time_range,1))-min_baseline)];
...
writematrix(drugs_avg_dataset,'C:\Users\Hector Acaron\Dropbox\2019 Dendrites Meeting\SAC Recordings\Drugs_avgTraces.txt')
