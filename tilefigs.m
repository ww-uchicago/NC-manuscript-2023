...
% matlabMonitorSize = monitorPositions(:,3:4) - monitorPositions(:,1:2) +
% 1; %this is not right for the second monitor. the size is just 3:4 of
% monitorPositions for matlab 2021a. - Wei
