...
folder= uigetdir('/Volumes/Elements/Backup 05102016/Wei Lab HD/recordings/New Rig/20151106');
...
for i=1:size(ptrace,2)
    ...
    save_plot_path = ['/Users/hectoracaron/Desktop/Hector/Plots/275' save_plot_fn];
    if save_plots == 1
